    ...
    if curr_frame is None:
        ...
        for obj in data:
            if len(obj["bounding_box"]) != 0:
                ...
                strong05_results[obj["cb_id"]].append("not_detected")
        # get track_ids for detected bboxes
        track_ids = strong05_tracker.update(bboxes, curr_frame)
        # assign track_id for every detected bbox
        track_ids_counter = 0
        used_track_ids = set()
        for obj in data:
            if len(obj["bounding_box"]) != 0:
                ...
                strong05_results[obj["cb_id"]].append(track_id)
...
async def websocket_endpoint(websocket: WebSocket):
    ...
    for el in track_data:
        ...
        el_strong_0_5 = tracker_strong_0_5(el)
        # отправка информации по фрейму
        await websocket.send_json(el_strong_0_5)
